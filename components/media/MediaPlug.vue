    ...
    <div class="media-plug">
        ...
        <ul class="media-plug__social">
            <li class="media-plug__social-item">
                <a class="media-plug__social-link" href="https://www.facebook.com/IQOSA/" target="_blank" rel="nofollow noopener noreferrer">Facebook</a>
                <span class="media-plug__social-line"></span>
            </li>
            <li class="media-plug__social-item">
                <a class="media-plug__social-link" href="https://www.pinterest.com/iqosa/_created/" target="_blank" rel="nofollow noopener noreferrer">Pinterest</a>
                <span class="media-plug__social-line"></span>
            </li>
            <li class="media-plug__social-item">
                <a class="media-plug__social-link" href="https://www.instagram.com/iqosa/" target="_blank" rel="nofollow noopener noreferrer">Instagram</a>
                <span class="media-plug__social-line"></span>
            </li>
        </ul>
    </div>
