    ...
    <div class="social">
        <ul class="social__list">
            <li class="social__item" @mouseover="$emit('showCursive', $event)" @mouseleave="$emit('hideCursive', $event)">
                <a target="_blank" href="https://www.facebook.com/IQOSA/" class="social__link">Facebook,</a>
                <a target="_blank" href="https://www.facebook.com/IQOSA/" class="social__link social__link--cursive">Facebook,</a>
            </li>
            <li class="social__item" @mouseover="$emit('showCursive', $event)" @mouseleave="$emit('hideCursive', $event)">
